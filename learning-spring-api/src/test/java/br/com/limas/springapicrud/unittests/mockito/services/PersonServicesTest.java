package br.com.limas.springapicrud.unittests.mockito.services;
...
import br.com.limas.springapicrud.mocks.MockPerson;
...
class PersonServicesTest {
	...
	void testFindById() {
		...
		assertEquals("Addres Test1", result.getAddresss());
	...
	void testFindAll() {
		...
		assertEquals("Addres Test1", personOne.getAddresss());
		...
		assertEquals("Addres Test4", personFour.getAddresss());
		...
		assertEquals("Addres Test7", personSeven.getAddresss());
